...
// ============================================
// КОНФИГУРАЦИЯ (укажи свои пути здесь)
// ============================================
...
// Пути к видео (укажи свои)
const string INPUT_VIDEO = "C:/Дурачок/vid.mp4";   // Исходное видео
const string OUTPUT_VIDEO = "C:/Дурачок/result.avi";    // Результат

// Настройки обработки
const int    FRAME_STEP = 1;      // Каждый N-й кадр сохранять в базу (1 = все)
const float  CONFIDENCE = 0.5f;   // Порог уверенности детекции
